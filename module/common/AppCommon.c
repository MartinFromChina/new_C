...
static const int crc16_ccitt_table[] = { 0x0000, 0x1021, 0x2042, 0x3063, 0x4084, 0x50a5, 0x60c6, 0x70e7, 0x8108, 0x9129, 0xa14a,
...
{
	uint16_t crc_reg = crc_init;
	for (uint32_t i = 0; i < length; i++) 
	{
		crc_reg = (crc_reg >> 8) ^ crc16_ccitt_table[(crc_reg ^ p_data[i]) & 0xff];
	}
//////	return crc_reg;
//////	INSERT(LogDebug)(NB_IAP_DATA_DEBUG,("CRC :%2x \r\n",crc_reg));
	return crc_reg;
}
