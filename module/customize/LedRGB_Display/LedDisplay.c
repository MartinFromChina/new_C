...
typedef struct
{
	...
	sLedDisplayParam        const *p_on_off_param_backup;
	X_Boolean               (*onWaitMethod)(X_Void);
	sLedBlink	              current_blink_param;
	uint16_t								blink_cycle_counter;
}sLedStateParam;

static sLedStateParam sLSP;
...
static StateNumber LS_IdleAction(s_StateMachineParam *p_this)
{
...
static StateNumber LS_LoadEventAction(s_StateMachineParam *p_this)
{
	X_Boolean isOK;
	uint16_t  bufnumber;
	sLedStateParam *p_ext 	= (sLedStateParam *)p_this;
...
static StateNumber LS_ReadyForEventAction(s_StateMachineParam *p_this)
{
...
static StateNumber LS_RecoverAction(s_StateMachineParam *p_this)
{
		sLedStateParam *p_ext 	= (sLedStateParam *)p_this;
		if(p_ext ->color_backup != ColorOff)
		{
...
static StateNumber LS_BlinkOnAction(s_StateMachineParam *p_this)
{
		sLedStateParam *p_ext 	= (sLedStateParam *)p_this;
...
static StateNumber LS_BlinkOffAction(s_StateMachineParam *p_this)
{
		sLedStateParam *p_ext 	= (sLedStateParam *)p_this;
...
static StateNumber LS_WaitAction(s_StateMachineParam *p_this)
{
	sLedStateParam *p_ext = (sLedStateParam *)p_this;
